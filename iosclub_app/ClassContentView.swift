                ...
                ZStack{
                    ...
                    VStack{
                        ...
                        Text("弟子規，聖人訓，首孝弟，次謹信，汎愛眾，而親仁，有餘力， 則學文。父母呼，應勿緩。父母命，行勿懶。父母教，須敬聽。父母責， 須順承。冬則溫，夏則凊；晨則省，昏則定。出必告，反必面；居有 常，業無變。事雖小，勿擅為；茍擅為，子道虧。物雖小，勿私藏； 茍私藏，親心傷。親所好，力為具，親所惡，謹為去；身有傷，貽親 憂，德有傷，貽親羞。親愛我，孝何難；親憎我，孝方賢。親有過， 諫使更；怡吾色，柔吾聲。諫不入，悅復諫；號泣隨，撻無怨。親有 疾，藥先嘗；晝夜侍，不離床。喪三年，常悲咽；居處變，酒肉絕。 喪 盡禮，祭盡誠； 事死者，如事生。")
                            ...
                            .frame(minWidth: UIScreen.screenWidth*0.6, idealWidth: UIScreen.screenWidth*0.6, maxWidth: UIScreen.screenWidth*0.7
                    ...
                    VStack{
                        ...
                        .foregroundColor(.white).font(.system(.body,design:.rounded)).border(Color.gray, width: 1).frame(minWidth: UIScreen.screenWidth*0.6, idealWidth: UIScreen.screenWidth*0.6, maxWidth: UIScreen.screenWidth*0.7
                            ,maxHeight:UIScreen.screenHeight*0.2)
                        .offset(x: 0,y: 90)
                    }
                    Button(action: {
