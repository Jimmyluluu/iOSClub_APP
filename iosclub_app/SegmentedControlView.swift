...
struct SegmentedPicker: View {
    ...
    private static let BackgroundColor: Color = Color(hex:"0A0A0A")
    private static let ShadowColor: Color = Color(hex:"0A0A0A").opacity(0.2)
    private static let TextColor: Color = Color(.gray)
    ...
    @State private var segmentSize: CGSize = CGSize(width: 10, height: 10)
    ...
    private var activeSegmentView: AnyView {
        ...
        return
            RoundedRectangle(cornerRadius: SegmentedPicker.SegmentCornerRadius)
                ...
                .offset(x: self.computeActiveSegmentHorizontalOffset()+55, y: 20)
